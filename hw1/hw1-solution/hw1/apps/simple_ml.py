...
from needle.ops import exp, log, summation
...
def softmax_loss(Z, y_one_hot):
    ...
    log_sum_exp_Z = log(sum_exp_Z)
    total_log_sum_exp_Z = summation(log_sum_exp_Z)

    product_Z_y_one_hot = Z * y_one_hot
    sum_product_Z_y_one_hot = summation(product_Z_y_one_hot)

    loss = (total_log_sum_exp_Z - sum_product_Z_y_one_hot) / Z.shape[0]
    return loss
    ### END YOUR SOLUTION
